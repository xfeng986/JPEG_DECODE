 ...
 * 
 * FILENAME
 *     FA93_VPOST_GOWORLD_GWMTF9615A.c
 *
 * VERSION
 *     0.1 
 *
...
void GWMTF9615A_WriteReg(UINT8 u8Reg, UINT16 u16Data)
{
	UINT16 ii;
	UINT32 u32SentData;
...
void GOWORLD_GWMTF9615A_Init(void)
{
...
#if 1
//	GWMTF9615A_WriteReg(0x05, 0xBC40);
//	GWMTF9615A_WriteReg(0x05, 0xB4C0);
	GWMTF9615A_WriteReg(0x05, 0xBC40); // with VDEN output
//	GWMTF9615A_WriteReg(0x05, 0xB440);
//	GWMTF9615A_WriteReg(0x17, 0x1014);			

#else		
	GWMTF9615A_WriteReg(0x01, 0x0000);
	GWMTF9615A_WriteReg(0x02, 0x0200);
	GWMTF9615A_WriteReg(0x03, 0x6364);	
	GWMTF9615A_WriteReg(0x04, 0x0400);		
//	GWMTF9615A_WriteReg(0x05, 0x0000);
	GWMTF9615A_WriteReg(0x0A, 0x4008);
	GWMTF9615A_WriteReg(0x0B, 0xD400);	
	GWMTF9615A_WriteReg(0x0D, 0x3229);		
	GWMTF9615A_WriteReg(0x0E, 0x3200);
	GWMTF9615A_WriteReg(0x0F, 0x0000);
	GWMTF9615A_WriteReg(0x16, 0x9F80);	
//	GWMTF9615A_WriteReg(0x17, 0x0000);		
	GWMTF9615A_WriteReg(0x30, 0x0000);
	GWMTF9615A_WriteReg(0x31, 0x0407);
	GWMTF9615A_WriteReg(0x32, 0x0202);	
	GWMTF9615A_WriteReg(0x33, 0x0000);		
	GWMTF9615A_WriteReg(0x34, 0x0505);
	GWMTF9615A_WriteReg(0x35, 0x0003);
	GWMTF9615A_WriteReg(0x36, 0x0707);	
	GWMTF9615A_WriteReg(0x37, 0x0000);		
	GWMTF9615A_WriteReg(0x3A, 0x0904);
	GWMTF9615A_WriteReg(0x3B, 0x0904);
	GWMTF9615A_WriteReg(0x01, 0x0000);	
	GWMTF9615A_WriteReg(0x01, 0x0000);		
	GWMTF9615A_WriteReg(0x01, 0x0000);
	GWMTF9615A_WriteReg(0x01, 0x0000);
...
INT vpostLCMInit_GOWORLD_GWMTF9615A(PLCDFORMATEX plcdformatex, UINT32 *pFramebuf)
{
	volatile S_DRVVPOST_SYNCLCM_WINDOW sWindow = {1440,272,480};	
	volatile S_DRVVPOST_SYNCLCM_HTIMING sHTiming = {3,129,(UINT8)168};
	volatile S_DRVVPOST_SYNCLCM_VTIMING sVTiming = {11,13,4};	
//	volatile S_DRVVPOST_SYNCLCM_VTIMING sVTiming = {9,2,3};
//	volatile S_DRVVPOST_SYNCLCM_VTIMING sVTiming = {10,2,3};
...
INT32 vpostLCMDeinit_GOWORLD_GWMTF9615A(VOID)
{
	vpostVAStopTrigger();
	vpostFreeVABuffer();
