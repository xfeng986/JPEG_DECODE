 ...
 * 
 * FILENAME
 *     W55FA93_VPOST_SHARP_LQ035Q1DH02.c
 *
 * VERSION
 *     0.1 
 *
...
INT vpostLCMInit_SHARP_LQ035Q1DH02(PLCDFORMATEX plcdformatex, UINT32 *pFramebuf)
{
...
//	volatile S_DRVVPOST_SYNCLCM_VTIMING sVTiming = {1,0x1,0x2};
	volatile S_DRVVPOST_SYNCLCM_HTIMING sHTiming = {4,0x56,(UINT8)0x56};
	volatile S_DRVVPOST_SYNCLCM_VTIMING sVTiming = {1,0x3,0x3};
...
//	u32ClockDivider = u32PLLclk / 9000;
	u32ClockDivider = u32PLLclk / 5000;
...
INT32 vpostLCMDeinit_SHARP_LQ035Q1DH02(VOID)
{
	vpostVAStopTrigger();
	vpostFreeVABuffer();
