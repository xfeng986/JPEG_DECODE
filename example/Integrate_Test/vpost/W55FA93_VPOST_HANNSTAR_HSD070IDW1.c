 ...
 * 
 * FILENAME
 *     FA93_VPOST_HANNSTAR_HSD070IDW1.c
 *
 * VERSION
 *     0.1 
 *
...
INT vpostLCMInit_HANNSTAR_HSD070IDW1(PLCDFORMATEX plcdformatex, UINT32 *pFramebuf)
{
	volatile S_DRVVPOST_SYNCLCM_WINDOW sWindow = {800,480,800};	
//	volatile S_DRVVPOST_SYNCLCM_HTIMING sHTiming = {10,66,(UINT8)210};
	volatile S_DRVVPOST_SYNCLCM_HTIMING sHTiming = {48,40,(UINT8)40};
//	volatile S_DRVVPOST_SYNCLCM_VTIMING sVTiming = {10,21,2};
	volatile S_DRVVPOST_SYNCLCM_VTIMING sVTiming = {3,29,13};
...
//	u32PLLclk = sysGetPLLOutputKhz(eSYS_UPLL, 12000);	// CLK_IN = 12 MHz
	u32PLLclk = GetPLLOutputKhz(eUPLL, 27000);			// CLK_IN = 27 MHz
...
INT32 vpostLCMDeinit_HANNSTAR_HSD070IDW1(VOID)
{
	vpostVAStopTrigger();
	vpostFreeVABuffer();
...
#endif    //HAVE_HANNSTAR_HSD070IDW1
